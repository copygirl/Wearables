 ...
 * Allows accessing an entity's {@link IWearableSlot}s, getting and setting
 * which items are equipped through Wearables.
 * <p>
 * TODO: Entity-type-specific regions and slots. (Creepers have no arms!)
 */
public interface IWearablesEntity
{
	/** Returns this entity's available {@link WearablesRegion}s, such as
	 *  {@link WearablesRegion#CHEST} and {@link WearablesRegion#BACK}. */
	public Collection<IWearablesRegion> getWearablesRegions();
	
	/** Returns this entity's available {@link WearablesSlotType}s, such as
	...
	/**
	 * Returns this entity's available {@link WearablesSlotType}s for the specified {@link WearablesRegion},
	 * such as {@code chest:armor/chestplate}, {@code chest:neck/amulet}, and {@code chest:clothing/shirt},
	 * or an empty collection if region is not valid for this entity.
	 * @exception IllegalArgumentException Thrown if region is null.
	 */
